...
--
-- SQL functions (e.g. config.get_service_users_in_scope) and R helpers
...
CREATE TABLE IF NOT EXISTS config.shiny_user_roles (
    role_name  TEXT    NOT NULL PRIMARY KEY,
    perm_level INTEGER NOT NULL
);

INSERT INTO config.shiny_user_roles (role_name, perm_level) VALUES
    ('Admin',              2),
    ('Entwickler',         2),
